...
echo '<html><head>
    ...
    <link rel=\"stylesheet\" href=
          ...
          integrity=
                  \"sha384-y3tfxAZXuh4HwSYylfB+J125MxIs6mR5FOHamPBG064zB+AFeWH94NdvaCBm8qnd\"
          crossorigin=\"anonymous\">
    </head><body><button id="backBtn" class="btn btn-primary" onclick="back()">Back</button><script>function back(){window.location.replace("http://www.danielgontar.com/web_portfolio/coupons_project/mainMenu.php")}</script></body></html>';
?>
</body>
</html>
